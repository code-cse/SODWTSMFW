...
tf.app.flags.DEFINE_string('exp_name', 'july', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')
...
def main(unused_argv):
  ...
  # Make a namedtuple , containing the values of the hyperparameters that the model needs
