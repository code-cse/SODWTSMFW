...
class BeamSearchDecoder(object):
  ...
  def __init__(self, model, batcher, vocab):
    ...
    #self._saver = tf.train.import_meta_graph('log/pretrained_model/train/model-238410.meta') # we use this to load checkpoints for decoding
...
def get_decode_dir_name(ckpt_name):
  ...
  dirname = "decode_%s_%imaxenc_%ibeam_%imindec_%imaxdec" % ('test', FLAGS.max_enc_steps, FLAGS.beam_size, FLAGS.min_dec_steps, FLAGS.max_dec_steps)
